			...
			<div class="col-md-12 column">
				...
				<div class="row clearfix">
					...
					<div class="col-md-6 column">
						<form class="form-horizontal" action="management/updateUser"
							method="POST">
							<div class="form-group" style="text-align: center;">
								<label><font style="font-size: 40px;">用户修改</font> </label> <br>
								<br>
								<input name="membersUserID" type="hidden" value="${user.membersUserID }">
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="loginName" class="form-control"
										id="inputEmail3" onblur="checkformname()" value="${user.loginName }"> <span
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
								<input type="radio" id="inputSex" name="sex" value="Male" class="audio" <c:if test="${user.sex == 'Male' }">checked</c:if>>男&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio"
											id="inputSex" name="sex" value="Female" class="audio" <c:if test="${user.sex == 'Female' }">checked</c:if>>女
								</div>
							</div>
							<div class="form-group">
